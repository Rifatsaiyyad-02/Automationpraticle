...
//		       String d1= p1+25;
		        ...
		        String s6="Selenium";
		        String s7="selenium";//samall
		        String s8="Selenium";
		        System.out.println("Checking Equality of s6 & s7: " + s6.equals(s7));//f
		        System.out.println("Checking Equality of s6 & s8: " + s6.equals(s8));//t
		        System.out.println("Checking Equality of s6 & s7 with Ignore case: " + s6.equalsIgnoreCase(s7));//t
		        ...
		        String str6=new String("xyz");//create two object constant pool and non constant pool
		        String str7=str6.intern();//using intern() str7 object point non constant pool object
